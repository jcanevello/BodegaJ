        ...
        <div class="main-box">
            <form class="form-horizontal" action="" role="form" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="number" name="stock" class="form-control" id="inputemail">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">Precio (S/.)</label>
                    <div class="col-lg-6">
                        <input type="number" step="0.1" name="precio" class="form-control" id="inputtelefono">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label" for="datepickerDate">Fecha de Vencimiento</label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" id="datepickerDate" name="fecha_vencimiento" >
